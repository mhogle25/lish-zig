...
- **34 built-in operations** — arithmetic, comparison, logic, control flow, string, list, and higher-order functions
...
| Higher-Order | `map`, `foreach`, `apply`                             |
| Sequencing   | `proc`                                                |
...
| `builtins.zig`     | 34 built-in operations                               |
